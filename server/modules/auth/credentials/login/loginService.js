...
export default function createLoginService({ credentialsRepository, totpRepository, withConnection }) {
	const authRepository = { ...credentialsRepository, ...totpRepository, withConnection };
