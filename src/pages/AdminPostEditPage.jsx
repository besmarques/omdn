...
import {
	...
	useAdminPost,
	useUpdateAdminPost,
} from '../query/adminContentTypeQuery';
...
function LoadedEditor({
	...
	const [descriptionHtml, setDescriptionHtml] = useState(
		source.descriptionHtml || `<p>${source.description}</p>`,
	);
	...
	const [ingredients, setIngredients] = useState(
		contentType === 'recipe'
			? linesFromIngredients(source.ingredients)
			: '',
	);
